...
export default class Config {
  ...
  public static DEFUALT_MAP = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
  ...
  /**
   * The map for the creation of the shortURL
   */
  static get map(): string {
    const map = process.env["MAP"]
    return map ? map : this.DEFUALT_MAP
  }
